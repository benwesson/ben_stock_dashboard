...
export default function FundForm({ email, funds }: FundFormProps) {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      alert(`Successfully added ${formQuantity} to funds. You now have ${newFunds} in your account.`);
    } catch (error) {
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Input type="number" placeholder="Amount" name="quantity" min={0.01}required />
